                        ...
                        {pausedQuizzes.length > 0 && (
                            <div className="flex items-center gap-2">
                                ...
                                <button
                                    ...
                                    className={`px-4 py-2 bg-white border rounded-lg transition-all duration-200 flex items-center gap-2 ${showFilters ? 'border-amber-500 shadow-md' : 'border-slate-200 hover:bg-slate-50'
                                        }`}
                                >
