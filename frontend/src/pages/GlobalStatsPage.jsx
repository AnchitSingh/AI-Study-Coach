                    ...
                    <div className="inline-flex bg-white/80 backdrop-blur-sm rounded-lg p-0.5 border border-slate-200 self-start sm:self-auto">
                        {[
                            ...
                            <button
                                ...
                                className={`px-3 py-1.5 rounded-md text-xs font-medium transition-all duration-200 ${timeRange === option.value
                    ...
                    <div className="flex gap-2 mb-4 border-b border-slate-200">
                        {topicTabs.map((tab) => (
                            <button
                                ...
                                className={`px-4 py-2 text-sm font-medium transition-all duration-200 border-b-2 ${activeTopicTab === tab.id
                                    ...
                                    <div className="flex items-center text-xs text-slate-600">
                                        ...
                                        {topic.trend && (
                                            <>
                                                ...
                                                <span className={`capitalize ${topic.trend === 'improving' ? 'text-green-600' :
