  ...
  useEffect(() => {
    ...
    if (!isBulkEvaluating) {
      messageInterval = setInterval(() => {
        setCurrentMessage((prev) => (prev < currentMessages.length - 1 ? prev + 1 : prev));
      }, 2000);
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm animate-backdrop-in">
      <div className="bg-white/95 backdrop-blur-sm rounded-3xl p-8 max-w-sm mx-4 text-center shadow-2xl border border-white/20 animate-modal-in">
        ...
        <div className="relative mb-6">
          ...
          ></div>
          <div
            className="absolute -bottom-2 -left-2 w-2 h-2 bg-amber-400 rounded-full animate-bounce"
        ...
        {/* Fun subtitle */}
        <p className="text-sm text-slate-500">Gemini is working its magic...</p>
