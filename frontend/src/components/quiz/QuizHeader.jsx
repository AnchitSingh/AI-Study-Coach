            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4">
                ...
                <div className="sm:hidden">
                    ...
                    <div className="flex items-center justify-between mb-3">
                        ...
                        {/* Timer (Mobile) */}
                        <div className={`flex items-center space-x-1.5 rounded-full px-3 py-1.5 shadow-sm border ${isTimeWarning
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                            ...
                            <button
                                onClick={onBookmark}
                                className={`p-1.5 rounded-lg transition-all duration-200 shadow-sm ${isBookmarked
                ...
                <div className="hidden sm:flex lg:hidden items-center justify-between">
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        {/* Timer (Tablet) */}
                        <div className={`flex items-center space-x-2 rounded-full px-4 py-2 shadow-lg border ${isTimeWarning
                                ? 'bg-red-50 border-red-200'
                                : 'bg-white/90 border-amber-100'
                            }`}>
                            <TimerIcon />
                            <span className={`font-mono text-base font-semibold ${isTimeWarning ? 'text-red-700 animate-pulse' : 'text-slate-700'
                                }`}>
                                {formatTime(timeLeft)}
                            </span>
                        </div>
                ...
                <div className="hidden lg:flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <div className="flex items-center space-x-2">
                            <button
                                onClick={onBookmark}
                                className={`p-2 rounded-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 shadow-sm border ${isBookmarked
                        ...
                        <div className={`flex items-center space-x-2 rounded-full px-4 py-2 shadow-lg border ${isTimeWarning
                            ...
                            <TimerIcon />
                            <span className={`font-mono text-lg font-semibold ${isTimeWarning ? 'text-red-700 animate-pulse' : 'text-slate-700'
                                }`}>
                                {formatTime(timeLeft)}
                            </span>
                        </div>
